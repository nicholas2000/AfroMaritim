                ...
                <form method="post" action="{{ url('masterHistory/update/') }}">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 form-group">
                            ...
                            <div class="p">
                                <div class="col-md-8">No Kapal</div>
                                <div>:</div>
                                <div class="col-md-2"><input name="nokapal" type='text' style="width: 180px;">
                                </div>
                            </div>
                            <br>
                            <div class="p">
                                <div class="col-md-8">No Container</div>
                                <div>:</div>
                                <div class="col-md-2"><input name="nocontainer" type='text' style="width: 180px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 form-group">
                            ...
                            <div class="p" style="margin-left: 10%;">
                                <div class="col-md-6">Tanggal Pengiriman</div>
                                <div>:</div>
                                <div class="col-md-6"><input name="tglberangkat" class="form-control" type="date" style="width: 180px; margin-top: -2px; ">
                                </div>
                            </div>
                            <br>
                            <div class="p " style="margin-left: 10%;" >
                                <div class="col-md-6">Nama Kurir</div>
                                <div>:</div>
                                <div class="col-md-6">
                                    <select name="namakurir" style="height:35px; width: 180px; " class="form-control selectpicker">
                            ...
                            <br>
                            <button style="float: right;margin-right: -5%" id="update" type="submit" class="btn btn-success">Update</button>
                            <br>
                        </div>
                    </div>
                </form>
                ...
                <div class="col-12">
                    <table class="table table-bordered">
                        <tr style="background-color:  #023e94;color: white;">
                            <th> <center> <input type="checkbox" name="" id=""></th></center>
                            <th scope="col">No</th>
                            <th scope="col">
                            ...
                            <th scope="col">
                                <center>Tannggal Pengiriman</center>
                            </th>
                            <th scope="col">
