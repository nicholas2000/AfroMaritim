...
<body>
    ...
    <!-- Form Add Box Model -->
    <legend><h2><b>Tambah Cabang</b></h2></legend><br>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10 inputGroupContainer">
            <div class="input-group">
                ...
                <input onkeypress="return onlyNumberKey(event)" name="npwp" placeholder="Masukkan Jumlah Pegawai" class="form-control"  type="text">
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10 inputGroupContainer">
            <div class="input-group">
                ...
                <input onkeypress="return onlyNumberKey(event)" name="hp" placeholder="Masukkan Nomer Telpon" class="form-control"  type="telp">
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="col-md-1 control-label" style="margin-top: -10px">Google Maps</label>
            <div class="col-md-10 inputGroupContainer">
            <div class="input-group">
                <span style="background-color: #ec1d24" class="input-group-addon"><i style="color: white"  class="fa fa-map"></i></span>
