...
<body>
    ...
    <!-- Form Add Customer -->
    <legend><h2><b>Tambah Customer</b></h2></legend><br>
    ...
    <!--input batasan-->
    <div class="form-group">
        <label class="col-md-1 control-label" style="margin-top: -10px;">Batasan Hutang</label>
        <div class="col-md-10 inputGroupContainer">
            <div class="input-group">
                <span style="background-color: #ec1d24" class="input-group-addon"><i style="color: white"  class="glyphicon glyphicon-usd"></i></span>
                <input  name="batasanHutang" placeholder="Masukkan Batasan Hutang" class="form-control" type="text">
            </div>
        </div>
    </div>

    <!--input hutang sekarang-->
    <div class="form-group">
        <label class="col-md-1 control-label" style="margin-top: -10px;">Hutang Sekarang</label>
        <div class="col-md-10 inputGroupContainer">
            <div class="input-group">
                <span style="background-color: #ec1d24" class="input-group-addon"><i style="color: white"  class="glyphicon glyphicon-usd"></i></span>
                <input  name="hutangSekarang" placeholder="Masukkan Hutang Sekarang" class="form-control" type="text">
            </div>
        </div>
    </div>

    <!--input hutang tersedia-->
    <div class="form-group">
        <label class="col-md-1 control-label" style="margin-top: -10px;">Hutang Tersedia</label>
        <div class="col-md-10 inputGroupContainer">
            <div class="input-group">
                <span style="background-color: #ec1d24" class="input-group-addon"><i style="color: white"  class="glyphicon glyphicon-usd"></i></span>
                <input  name="hutangTersedia" placeholder="Masukkan Hutang Tersedia" class="form-control" type="text">
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10 inputGroupContainer">
            <div class="input-group">
                <span style="background-color: #ec1d24" class="input-group-addon"><i style="color: white"  class="fa fa-credit-card"></i></span>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10 selectContainer">
            <div class="input-group">
                <span style="background-color: #ec1d24" class="input-group-addon"><i style="color: white"  class="fa fa-university"></i></span>
                <select name="metodePembayaran" style="height:35px" class="form-control selectpicker">
